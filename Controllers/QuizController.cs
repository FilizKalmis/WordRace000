...
namespace WordRace000.Controllers
{
    ...
    public class QuizController : Controller
    {
        ...
        public async Task<IActionResult> StartQuiz()
        {
            ...
            // 1. Bugün tekrar edilmesi gereken kelimeleri al
            ...
            // 2. Kullanıcı ayarlarından yeni kelime sayısını al
            var settings = await _context.Settings
                .FirstOrDefaultAsync(s => s.UserId == userId);
            int newWordCount = settings?.DailyWordCount ?? 10;

            // 3. Yeni kelimeler seç (hiç test edilmemiş veya schedule'da olmayan kelimelerden)
            ...
            // 4. Tüm kelime ID'lerini birleştir
            ...
            // 7. Yeni kelimeler için QuizSchedule kayıtları oluştur
